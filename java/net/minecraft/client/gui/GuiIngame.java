...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float p_73830_1_, boolean p_73830_2_, int p_73830_3_, int p_73830_4_)
    {
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
            ...
            GL11.glPushMatrix();
            fontrenderer.drawStringWithShadow("LostZone (" + this.mc.debug + ")", 2, 2, 16777215);
            ...
            this.drawString(fontrenderer, String.format("shader: %s", new Object[] {this.mc.entityRenderer.getShaderGroup().getShaderGroupName()}), 2, 142, 14737632);
